...
class ImageLoad:
    def __init__(self, content_path, style_path):
        ...
        self.content_img = self.content_loader(content_path)
        self.style_img = self.style_loader(style_path)
    ...
    def style_loader(self, image_name):
        size = [self.content_img.size()[2], self.content_img.size()[3]]
...
class NeuralStyleTransfer:
    ...
    def run_style_transfer(self, normalization_mean, normalization_std,
        ...
        model, style_losses, content_losses = self.get_style_model_and_losses(normalization_mean, normalization_std,
                                                                              style_img, content_img)
...
async def transferring(content_path, style_path, output_path):
    ...
    del device
    del input_img
    del cnn_normalization_mean
    del cnn_normalization_std
